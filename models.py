...
class Room(db.Model):
    ...
    video_id = db.Column(db.Integer, db.ForeignKey('video.id'), unique=True, nullable=True)
...
class Rating(db.Model):
    ...
    __table_args__ = (db.UniqueConstraint('user_id', 'video_id', name='unique_user_video_rating'),)
